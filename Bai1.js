// Hàm 1: Tôi Là Ai (Hồ Sơ Sinh Viên)
function showme1() {
    let getshowme = `
        <div class="card">
    ...
    `;
    document.getElementById("content-1").innerHTML = getshowme;
}

// Hàm 2: Hiển thị Chuyên ngành
function showme2() {
    let content = `
        <div class="card">
            <div class="section-title">
...
function showme3() {
    ...
    `;
    document.getElementById("content-3").innerHTML = content;
}

// Mặc định tải nội dung tab 1 khi mở trang
